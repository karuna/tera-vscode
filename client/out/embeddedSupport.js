...
exports.getDocumentRegions = exports.getCSSVirtualContent = exports.isInsideStyleRegion = exports.CSS_STYLE_RULE = void 0;
const vscode_languageclient_1 = require("vscode-languageclient");
const vscode_html_languageservice_1 = require("vscode-html-languageservice");
exports.CSS_STYLE_RULE = '__';
function isInsideStyleRegion(languageService, documentText, offset) {
...
exports.isInsideStyleRegion = isInsideStyleRegion;
function getCSSVirtualContent(languageService, documentText) {
    const regions = [];
    const scanner = languageService.createScanner(documentText);
    let lastTagName = '';
...
exports.getCSSVirtualContent = getCSSVirtualContent;
...
function getLanguageRanges(document, regions, range) {
    const result = [];
    let currentPos = range ? range.start : vscode_languageclient_1.Position.create(0, 0);
...
function getEmbeddedDocument(document, contents, languageId, ignoreAttributeValues) {
    ...
    return vscode_languageclient_1.TextDocument.create(document.uri, languageId, document.version, result);
}
